...
public class VrpServiceDuration {

    private GraphHopper graphHopper;

    public VrpServiceDuration() {
        try {
            graphHopper = new GraphHopper();
            graphHopper.setGraphHopperLocation("target/routing-graph-cache-dur");
    ...
    public String solveVrpByDuration(VrpRequest vrpRequest) {
        ...
        for (VehicleRoute route : bestSolution.getRoutes()) {
            ...
            for (TourActivity activity : route.getActivities()) {
                ...
                serviceActivity.setDuration(travelTime / 1000);  // Convert time to seconds
                routeResponse.getActivities().add(serviceActivity);

                previousLocation = activity.getLocation();
            }

            routeResponse.setDuration(routeTime / 1000); // Convert to seconds
